...
const currentPatient = {
  ...
  previousDiagnosis: "Acne Vulgaris (Grade II)",
  previousMedications: ["Clindamycin Gel 1%", "Adapalene 0.1% Gel"],
  notes: "",
}

const DoctorCurrentPatient = () => {
  const isFollowUp = currentPatient.visitType === "Follow-up"
        ...
        <div className="bg-[#d3e5ff] px-6 py-3 dark:bg-[#0070f3]/20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[14px] font-medium text-[#0761d1] dark:text-[#50e3c2]">
              Consultation in progress — Token #{currentPatient.token}
            </span>
          </div>
        ...
        <div className="p-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/3">
              <div className="flex flex-col items-center rounded-[12px] border border-[#ebebeb] bg-[#fafafa] py-8 px-6 text-center dark:border-white/10 dark:bg-[#171717]">
                ...
                <p className="mt-1 text-[14px] text-[#888888]">Age {currentPatient.age}</p>
                <p className="mt-0.5 text-[13px] text-[#888888]">{currentPatient.phone}</p>
              ...
              <div className="mt-4 flex flex-col gap-3">
                <div className="flex items-center justify-between py-2 border-b border-[#ebebeb] dark:border-white/10">
                  ...
                  <span className="text-[13px] text-[#171717] dark:text-white">{currentPatient.lastVisit}</span>
                </div>
                <div className="flex items-center justify-between py-2">
                  ...
                  <span className="text-[13px] font-medium text-[#171717] dark:text-white">{currentPatient.visitType}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6 flex-1">
              ...
              {isFollowUp && (
                <div className="rounded-[12px] border border-[#ebebeb] bg-[#fafafa] p-5 dark:border-white/10 dark:bg-[#171717]">
                  ...
                  <p className="text-[13px] text-[#4d4d4d] dark:text-[#888888] mb-3">
                    ...
                    {currentPatient.previousDiagnosis}
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {currentPatient.previousMedications.map((med) => (
